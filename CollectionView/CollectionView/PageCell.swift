...
class PageCell: UICollectionViewCell {
    ...
    lazy var Button1: UIButton = {
        ...
        buttonView.addTarget(self, action: #selector(AddPoints), for: .touchUpInside)
    ...
    lazy var buttons:Array<UIButton> = [Button1,Button2,Button3,Button4]
...
//
//        debugPrint(sender.tag, buttons[sender.tag].isSelected)
//    }
